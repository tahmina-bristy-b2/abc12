...
class HiveAdapter {
  hiveAdapterbox() async {
    ...
    Hive.registerAdapter(DoctorCategoryRestDataAdapter());
    Hive.registerAdapter(EcmeTerritoryRestDoctorModelAdapter());
    ...
    await Hive.openBox<DoctorCategoryRestData>('eCMEDOctorCategory');
    await Hive.openBox<EcmeTerritoryRestDoctorModel>('eCMEDoctorListNew');
  }
}
