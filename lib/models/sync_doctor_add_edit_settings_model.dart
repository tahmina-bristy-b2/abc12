...
//
//     final synDoctorAddEditSettings = synDoctorAddEditSettingsFromJson(jsonString);

import 'dart:convert';

SynDoctorAddEditSettings synDoctorAddEditSettingsFromJson(String str) =>
    SynDoctorAddEditSettings.fromJson(json.decode(str));

String synDoctorAddEditSettingsToJson(SynDoctorAddEditSettings data) =>
    json.encode(data.toJson());

class SynDoctorAddEditSettings {
  SynDoctorAddEditSettings({
    required this.resData,
  });

  final ResData resData;

  factory SynDoctorAddEditSettings.fromJson(Map<String, dynamic> json) =>
      SynDoctorAddEditSettings(
