  ...
  Future<UserLoginModel> login(
    ...
    try {
      ...
      if (status == 'Success') {
        ...
        bool offer_flag = userInfo['offer_flag'];
        bool note_flag = userInfo['note_flag'];
        bool client_edit_flag = userInfo['client_edit_flag'];
        bool os_show_flag = userInfo['os_show_flag'];
        bool os_details_flag = userInfo['os_details_flag'];
        bool ord_history_flag = userInfo['ord_history_flag'];
        bool inv_histroy_flag = userInfo['inv_histroy_flag'];
        bool timer_flag = userInfo['timer_flag'];
        bool rx_doc_must = userInfo['rx_doc_must'];
        bool rx_type_must = userInfo['rx_type_must'];
        bool rx_gallery_allow = userInfo['rx_gallery_allow'];
