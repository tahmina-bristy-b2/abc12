...
class ItemsExpiredDatedScreen extends StatefulWidget {
  ...
  @override
  State<ItemsExpiredDatedScreen> createState() =>
      _ItemsExpiredDatedScreenState();
}
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      for (var element in widget.expiredItemSubmitModel) {
                        if (element.itemId ==
                            filteredItems[itemIndeex].itemId) {
                            ...
                            return Theme(
                                ...
                                child: ExpiredIteminputShowDialogScreen(
                                  ...
                                  callbackFunction: (value) async {
                                    if (value != null) {
                                      widget.expiredItemSubmitModel.removeWhere(
                                          (element) =>
                                  ...
                                  clinetId: widget.customerInfo["client_id"],
                                  itemId: filteredItems[itemIndeex].itemId,
                                ));
                          });
                      setState(() {});
                    },
          ...
          Expanded(
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  onChanged: (value) {
                    filteredItems = ExpiredServices()
                        .searchDynamicMethod(value, widget.syncItem);
                    setState(() {});
                  },
                    ...
                    suffixIcon: searchController.text.isEmpty &&
                        ...
                        : IconButton(
                            onPressed: () {
                              ...
                              filteredItems = ExpiredServices()
                                  .searchDynamicMethod('', widget.syncItem);
                              setState(() {});
                            },
                            icon: const Icon(
                              Icons.clear,
