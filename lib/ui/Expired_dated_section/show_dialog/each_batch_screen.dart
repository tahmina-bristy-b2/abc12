...
import 'package:MREPORTING_OFFLINE/ui/Expired_dated_section/widget/textform_field_custom.dart';
                    ...
                    ? Expanded(
                        ...
                        onTapFuction: () {
                          if (batchcontroller.text != "" &&
                              qtyController.text != "") {
                            final item = BatchWiseItemListModel(
                                batchId: batchcontroller.text,
                                expiredDateTime: selectedExpiredDate,
