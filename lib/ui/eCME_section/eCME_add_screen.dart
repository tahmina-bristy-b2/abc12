...
import 'package:MREPORTING_OFFLINE/ui/eCME_section/eCME_doctor_preview.dart';
import 'package:MREPORTING_OFFLINE/ui/eCME_section/widgets/add_title_row_widget.dart';
import 'package:MREPORTING_OFFLINE/ui/eCME_section/widgets/custom_dropdown_widget.dart';
...
class ECMEAddScreen extends StatefulWidget {
  ...
  const ECMEAddScreen(
      {super.key, required this.docInfo, required this.eCMEType});
...
class _ECMEAddScreenState extends State<ECMEAddScreen> {
  ...
  allSettingsDataGet(ECMESavedDataModel? eDSRsettingsData) {
    eBrandList =
        eDSRsettingsData!.eCMEBrandList.map((e) => e.brandName).toList();
    eCMETypeList =
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        ...
                                        child: Text(
                                          "${index + 1}. ${widget.docInfo[index].docName}|${widget.docInfo[index].degree}|${widget.docInfo[index].specialty}",
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: CustomtextFormFiledWidget(
                                  controller:
                                      initialValue(selectedExpiredDateString),
                              ...
                              //=============================== Doctor Category ====================================
                              AddTitleRowWidget(
                                  context: context, title: "Doctor Category*"),
                              ...
                              (totalParticipants() > 0)
                                  ? titleRowWidget(context, "Total budget*",
                                      "৳${totalBudget.toStringAsFixed(2)}")
                                  : const SizedBox(),
                              (totalParticipants() > 0)
                                  ? titleRowWidget(context, "Cost per doctor",
                                      "৳${getCostPerDoctor().toStringAsFixed(2)}")
                                  : const SizedBox(),
                              ...
                              (widget.eCMEType != null)
                                  ? Row(
                                      ...
                                      children: [
                                        ...
                                        brandAddWidget(
                                            wholeHeight, wholeWidth, context)
                                      ],
                                    )
                                  : const SizedBox(),
                              const SizedBox(
...
//========================================== Budget =================================
              ...
              child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    if (selectedExpiredDateString == "") {
                      AllServices().toastMessage("Please Select Meeting Date ",
                      ...
                      AllServices().toastMessage("Please Enter meeting venue ",
                          Colors.red, Colors.white, 16);
                    } else if (meetingTopicController.text == "") {
                      AllServices().toastMessage("Please Enter meeting topic ",
                          Colors.red, Colors.white, 16);
                    } else if (meetingProbaleSpeakerNameController.text == "") {
                      AllServices().toastMessage(
                          "Please Enter probable speaker Name ",
                          Colors.red,
                          Colors.white,
                          16);
                      ...
                      AllServices().toastMessage("Please add Institution Name ",
                        ...
                        selectedDepartment == null) {
                      AllServices().toastMessage("Please select department ",
                          Colors.red, Colors.white, 16);
                    } else if (totalBudget > eCME) {
                      AllServices().toastMessage("Please reduce your budget ",
                          Colors.red, Colors.white, 16);
                    } else {
  ...
  Column brandDetailsWidget(double wholeWidth, double wholeHeight) {
    return Column(
      children: [
        ...
        SizedBox(
          height: finalBrandListAftrRemoveDuplication.length * 30,
          width: wholeWidth / 1.073,
          child: ListView.builder(
              itemCount: finalBrandListAftrRemoveDuplication.length,
              itemBuilder: (context, index) {
                return Padding(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Center(
                              child: Text(
                                finalBrandListAftrRemoveDuplication[index][0],
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: Color.fromARGB(255, 0, 0, 0),
                                ),
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: Center(
                              child: Text(
                                finalBrandListAftrRemoveDuplication[index][2] ==
                                        ""
                                    ? "0"
                                    : finalBrandListAftrRemoveDuplication[index]
                                        [2],
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: Color.fromARGB(255, 0, 0, 0),
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    dynamicRowsListForBrand.removeAt(index);
  ...
  Container brandAddWidget(
      double wholeHeight, double wholeWidth, BuildContext context) {
    return Container(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    keyboardType: TextInputType.number,
                                    controller: widget.eCMEType == "RMP Meeting"
                                        ? salesQtyController
                                        : rxPerDayController,
                                    decoration: InputDecoration(
                                      border: OutlineInputBorder(
                                    ...
                                    child: InkWell(
                                        ...
                                        onTap: () {
                                          if (initialBrand != null) {
                                            if (widget.eCMEType == "RMP Meeting"
                                                ? salesQtyController.text != ""
                                                : rxPerDayController.text !=
                                                    "") {
                                              dynamicRowsListForBrand.add([
                                                initialBrand,
                                                eCMEAmountCOntroller.text == ""
                                                    ? "0"
                                                    : eCMEAmountCOntroller.text,
                                                widget.eCMEType == "RMP Meeting"
                                                    ? (salesQtyController
                                              ...
                                              print(
                                                  "unique brand List  ====$finalBrandListAftrRemoveDuplication");
                                              Navigator.pop(context);
                                              setState(() {
                                                initialBrand = null;
                                                rxPerDayController.clear();
  ...
  readyForPreviewMethod() {
    ...
    final ECMESubmitDataModel ecmeSubmitDataModel = ECMESubmitDataModel(
        ...
        brandString: ECMEServices().getbrandString(eCMESettingsData!,
            finalBrandListAftrRemoveDuplication, splitedAmount),
        areaId: areaId,
        ...
        institutionName: selcetDoctorCategory == "Institution"
            ? institutionController.text
            : "",
        departament:
            selcetDoctorCategory == "Institution" ? selectedDepartment! : "",
  ...
  pickDate() async {
    ...
    final _firstDay = DateTime(_today.year, _today.month, 1);
