...
class BillFeedbackUtils {
  Future<Uint8List> generatePdf(
      ...
      Map<String, dynamic> printOthersData) async {
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (final context) => pw.Column(children: [
          pw.Center(
              child: pw.Center(
            child: pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Row(children: [
                  ...
                  pw.Expanded(
                      ...
                      child: pw.Align(
                          alignment: pw.Alignment.centerLeft,
                          child: pw.Text(
                              dataListPrint.feedbackFormatDictData.sl,
                              style: pw.TextStyle(
                                  fontSize: 12,
                                  fontWeight: pw.FontWeight.bold)))),
                ]),
                ...
                pw.Row(children: [
                  ...
                  pw.Expanded(
                      ...
                      child: pw.Align(
                          alignment: pw.Alignment.centerLeft,
                          child: pw.Text(
                              dataListPrint.feedbackFormatDictData.date,
                              style: pw.TextStyle(
                                  fontSize: 11,
                                  fontWeight: pw.FontWeight.bold)))),
                ]),
                ...
                pw.Align(
                    alignment: pw.Alignment.centerLeft,
                    child: pw.Text(
                        "To, ${dataListPrint.feedbackFormatDictData.to}",
                        style: pw.TextStyle(
                            fontSize: 11, fontWeight: pw.FontWeight.bold))),
                pw.SizedBox(height: 5),
                pw.Row(children: [
                  ...
                  pw.Expanded(
                      ...
                      child: pw.Align(
                          alignment: pw.Alignment.centerLeft,
                          child: pw.Text(
                              dataListPrint.feedbackFormatDictData.from,
                              style: pw.TextStyle(
                                  fontSize: 11,
                                  fontWeight: pw.FontWeight.bold)))),
                ]),
                  ...
                  child: pw.Row(children: [
                    ...
                    pw.Expanded(
                        ...
                        child: pw.ListView.builder(
                            itemCount: dataListPrint
                                .feedbackFormatDictData.copy.length,
                            itemBuilder: ((context, index) {
                              return pw.SizedBox(
                                  child: pw.Row(children: [
                                pw.Text(
                                    "${dataListPrint.feedbackFormatDictData.copy[index]}  ",
                ...
                pw.Row(children: [
                  ...
                  pw.Expanded(
                      ...
                      child: pw.Align(
                          alignment: pw.Alignment.centerLeft,
                          child: pw.Text(
                              dataListPrint.feedbackFormatDictData.subject,
                              style: pw.TextStyle(
                                  fontSize: 11,
                                  fontWeight: pw.FontWeight.bold)))),
                ]),
      ...
      if (result) {
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
                content: Text(
                    "Feedback Letter (${dataListPrint.sl}) printed successfully")),
          );
        }
      } else {}
    } catch (e) {
  ...
  void showSharedToast(
      final BuildContext context,
      ApprovedPrintDataModel wholeData,
      DataListPrint dataListPrint,
      Map<String, dynamic> printOthersData) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            "Feedback Letter(${dataListPrint.sl}) shared successfully done")));
  }
}
