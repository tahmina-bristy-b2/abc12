...
Future<Uint8List> generatePdf(final PdfPageFormat format,
  ...
  List<List<String>> tableData = [
    ...
    ['3. Gift / Souvenir', dataListPrint.giftsSouvenirs.toString(), ''],
    [
      '4. Stationaries and Others (Pen, Photocopies etc)',
      dataListPrint.stationnaires.toString(),
      ''
    ],
  ...
  List<List<String>> brandData() {
    ...
    brandData.add([
      'TOTAL :',
      dataListPrint.ecmeAmount.toString(),
          ...
          child: pw.Column(
            ...
            children: [
              pw.Row(children: [
                pw.Expanded(
                    ...
                    child: pw.Align(
                        ...
                        child: pw.Text(
                            "SUBMISSION DATE :  ${dataListPrint.submitDate}",
                            style: pw.TextStyle(
                ...
                pw.Expanded(
                    ...
                    child: pw.Align(
                        alignment: pw.Alignment.centerLeft,
                        child: pw.Text(
                            "ID NUMBER OF RH:   ${wholeData.resData.rsmId.toUpperCase()}",
                            style: pw.TextStyle(
                                fontSize: 8, fontWeight: pw.FontWeight.bold)))),
              ]),
              ...
              expenseTableRowWidget(
                  "NAME & TERR.CODE OF RH ", dataListPrint.fmIdName),
              pw.Padding(padding: const pw.EdgeInsets.only(top: 2)),
              ...
              pw.Padding(padding: const pw.EdgeInsets.only(top: 2)),
              expenseTableRowWidget(
                  "TOTAL NO. OF PARTICIPANTS ", dataListPrint.doctorsCount),
              pw.Padding(padding: const pw.EdgeInsets.only(top: 2)),
              expenseTableRowWidget(
              ...
              pw.Padding(padding: const pw.EdgeInsets.only(top: 2)),
              expenseTableRowWidget("CME TYPE", dataListPrint.ecmeType),
            ],
          ),
        ),
        pw.Row(children: [
    ...
    if (result) {
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  "Bill Expense(${dataListPrint.sl}) printed successfully")),
        );
      }
    } else {}
  } catch (e) {
...
void showSharedToast(final BuildContext context,
  ...
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content:
          Text("Bill Expense(${dataListPrint.sl}) shared successfully done")));
}
